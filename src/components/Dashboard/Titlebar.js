...
import Messageemp from '../Actions/Messageemp';
import axios from 'axios';
import Messagecus from '../Actions/Messagecus';
import Managefuel from '../Actions/Managefuel';

import Manageoffers from '../Sales/Manageoffers';
import Alloffers from '../Sales/Alloffers';
...
const Titlebar = () => {
    ...
    const [dp, setProfile] = useState([])
      // set profile pic
      useEffect(() => axios.get(`http://localhost:3001/theemployee/picprof/${tokenemail}`)
      .then(function (response) {
          // handle success
          // console.log(response.data.data[0])
          setProfile(response.data.data[0].profilepic)
      }),[]
      )

      const mydp = `images/${dp}`
        ...
        <div className="titleandnav">
            <div className="maintopbar">
                ...
                <div className="maintopbarlog">
                    ...
                    <span  id="theuser1">{tokenemail}</span>                
                        {/* caret options */}
                    <FaCaretDown size="25" onClick={showLoggedaccount} id="thecareticon1" style={{verticalAlign: 'middle', cursor: 'pointer'}} />
                        <div className="thecaretbox" id="thecaretbox" style={{display:showorhideLoggedaccount}}>
                            <ul>
                                ...
                                {/* <Link to="/inbox">
                                    <li><FiMail size="20" style={{marginRight: '5px', verticalAlign: 'middle'}}/>Inbox</li>
                                </Link> */}
            ...
            <div className="bodymain">
                ...
                <div className="sidebar" style={{display:showorhidemenu}}>
                    ...
                    {role1 === "staff" ? 
                        <li>
                             <Nav.Link as={NavLink} to="/admin" exact ClassName="active" id="thenavlink">
                    ...
                    {role1 === "employee" ? 
                        <li>
                            <Nav.Link as={NavLink} to="/emp" exact ClassName="active" id="thenavlink">
                                <RiDashboardFill size="20" style={{marginRight: '5px', verticalAlign: 'middle'}}/>
                                DASHBOARD
                            </Nav.Link>
                        </li> : ""
                    ...
                    {role1 === "employee" ? 
                      ...
                      {role1 === "staff" ? 
                        <li>
                            <Nav.Link as={NavLink} to="/allsales" id="thenavlink">
                                <AiOutlineShop size="20" style={{marginRight: '5px', verticalAlign: 'middle',  color: 'white'}}/>
                                SALES
                            </Nav.Link>
                        </li>: ""
                ...
                <div className="maindashboard">
                    ...
                    <Route exact path="/newemployee" component={Registerform} />
                    ...
                    <Route exact path="/messageallemp" component={Messageemp} />
                    <Route exact path="/messageallcus" component={Messagecus} />
                    <Route exact path="/fuellevel" component={Managefuel} />
                   
                    <Route exact path="/alloffers" component={Alloffers} />
                    <Route exact path="/offers" component={Manageoffers} />
